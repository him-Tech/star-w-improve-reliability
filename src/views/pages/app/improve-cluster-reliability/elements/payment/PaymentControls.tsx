...
export function PaymentControls(props: PaymentControlsProps) {
  ...
  return (
    <>
      ...
      >
        {selectedPrice
          ? (productType === ProductType.donation ? `Donate ${displayedCurrency.symbol}${selectedPrice.totalAmount / 100}${priceType === PriceType.RECURRING ? "/mo" : ""}` : `Receive ${displayedCurrency.symbol}${selectedPrice.totalAmount / 100}${priceType === PriceType.RECURRING ? "/mo" : ""} of DoWs`)
